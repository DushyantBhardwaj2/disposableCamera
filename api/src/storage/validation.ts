...
export function validateUpload(fileName: string, fileType: string, size: number): ValidationResult {
...
export function extensionFromType(fileName: string, fileType: string): string {
...
export function toPublicMediaUrl(origin: string, rawUrl: string | null): string | null {
  if (!rawUrl) {
    return null
  }
